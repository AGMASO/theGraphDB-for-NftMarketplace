...
export class ItemListing extends ethereum.Event {
  get params(): ItemListing__Params {
    return new ItemListing__Params(this);
  }
}

export class ItemListing__Params {
  _event: ItemListing;

  constructor(event: ItemListing) {
    this._event = event;
  }
